...
export default function HydraBot() {
            ...
            <div className="flex h-screen w-screen items-center bg-gray-100">
                <div className="container flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
                    ...
                    <div className="mt-10 max-w-lg">
                        <img alt="" src="https://i.ibb.co/5Wx85j3/161942-Wolverine-artwork-white-background-simple-background-Marvel-Comics-Derek-Laufman-removebg-pre.png" />
                    </div>
                </div>
            </div>
